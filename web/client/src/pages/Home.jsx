...
function Home() {
  ...
  // Filter: only show events with markets (hides virtual sports with no data)
  const realEvents = events.filter(e => e.markets && e.markets.length > 0);
      ...
      <div className="mb-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-0.5">{realEvents.length} events with markets ({events.length} total) across {sortedSports.length} sports</p>
          </div>
